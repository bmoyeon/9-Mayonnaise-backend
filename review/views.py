...
class ReivewView(View):
    ...
    def get(self, request):
        try:
            ...
            reiview_list    =   Review.objects.filter(**filters)
            # total_count     =   len(reiview_list)
    ...
    def post(self, request, format = None):
        ...
        new_review = model_to_dict(new_review, fields=['user', 'product', 'skin_type', 'rate', 'review_image'])
